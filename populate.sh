...
curl -s  --header "Content-Type:application/json" "http://$ADDRESS" 2>&1 > /dev/null
if [ $? != 0 ]; then
...
curl -s  --header "Content-Type:application/json" -XDELETE "$ADDRESS/get-together" > /dev/null

# Create the next index using mapping.json
echo "Creating 'get-together' index..."
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together" -d@$(dirname $0)/mapping.json

# Wait for index to become yellow
curl -s  --header "Content-Type:application/json" "$ADDRESS/get-together/_health?wait_for_status=yellow&timeout=10s" > /dev/null
echo
...
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/group/1" -d'{
  "name": "Denver Clojure",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/group/2" -d'{
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/group/3" -d'{
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/group/4" -d'{
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/group/5" -d'{
...
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/100?parent=1" -d'{
  "host": ["Lee", "Troy"],
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/101?parent=1" -d'{
  "host": "Sean",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/102?parent=1" -d'{
  "host": "Daniel",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/103?parent=2" -d'{
  "host": "Lee",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/104?parent=2" -d'{
  "host": "Lee",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/105?parent=2" -d'{
  "host": "Lee",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/106?parent=3" -d'{
  "host": "Mik",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/107?parent=3" -d'{
  "host": "Mik",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/108?parent=3" -d'{
  "host": "Elyse",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/109?parent=4" -d'{
  "host": "Andy",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/110?parent=4" -d'{
  "host": "Andy",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/111?parent=4" -d'{
  "host": "Andy",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/112?parent=5" -d'{
  "host": "Dave Nolan",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/113?parent=5" -d'{
  "host": "Dave",
...
echo
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/event/114?parent=5" -d'{
  "host": "Yann",
...
curl -s  --header "Content-Type:application/json" -XPOST "$ADDRESS/get-together/_refresh"
...
curl -s  --header "Content-Type:application/json" -XPUT "http://$ADDRESS/_template/logging_index_all" -d'{
...
echo
curl -s  --header "Content-Type:application/json" -XPUT "http://$ADDRESS/_template/logging_index" -d '{
    "template" : "logstash-*",
    "order" : 0,
    "settings" : {
        "number_of_shards" : 2,
...
curl -s  --header "Content-Type:application/json" -XDELETE "http://$ADDRESS/myindex" > /dev/null
curl -s  --header "Content-Type:application/json" -XPUT "http://$ADDRESS/myindex" -d'
{
    "mappings" : {
        "my_type" : {
            "dynamic_templates" : [{
...
echo
echo "Adding Aliases"
curl -s  --header "Content-Type:application/json" -XDELETE "http://$ADDRESS/november_2014_invoices" > /dev/null
curl -s  --header "Content-Type:application/json" -XDELETE "http://$ADDRESS/december_2014_invoices" > /dev/null
curl -s  --header "Content-Type:application/json" -XPOST "http://$ADDRESS/november_2014_invoices" -d'{}'
echo
curl -s  --header "Content-Type:application/json" -XPOST "http://$ADDRESS/december_2014_invoices" -d'
{
    "mappings" :
    {
        "invoice" :
...
curl -s  --header "Content-Type:application/json" -XPOST "http://$ADDRESS/_aliases" -d'
{
    "actions" : [
	{
		"add" :
